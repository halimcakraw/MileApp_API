...
WS.comment('Delete email field from params')
...
'Send Request'
responseBody = WS.sendRequest(findTestObject('API/MileApp', [('organizationname') : organizationname, ('fullname') : fullname, ('phone_number') : phone_number,
...
WS.verifyElementPropertyValue(responseBody, 'message', 'The email field is required.')
