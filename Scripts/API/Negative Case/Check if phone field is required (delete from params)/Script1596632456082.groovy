...
WS.comment('Delete phone field from params')
...
'Send Request'
responseBody = WS.sendRequest(findTestObject('API/MileApp', [('organizationname') : organizationname, ('fullname') : fullname, ('email_address') : email_address,
...
WS.verifyElementPropertyValue(responseBody, 'message', 'The phone field is required.')
