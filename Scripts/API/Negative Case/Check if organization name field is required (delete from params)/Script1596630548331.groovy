...
WS.comment('Delete organization name from params')
...
'Send Request'
responseBody = WS.sendRequest(findTestObject('API/MileApp', [('fullname') : fullname, 
...
WS.verifyElementPropertyValue(responseBody, 'message', 'The organization name field is required.')
